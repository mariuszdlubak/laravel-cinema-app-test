<x-layout>
    <x-main-with-box>
        <x-breadcrumbs class="my-4"
            :links="['Admin Panel' => route('admin.index'), 'Movies Management' => route('admin.movies.index'), 'Add new' => '#']" />
        ...
        >
            ...
            <div class="w-full h-56 sm:h-96" x-data="{ imagePreview: null }">
                <label class="cursor-pointer">
                    ...
                    <div
                        @class([
                            'w-full h-full bg-bg-200 rounded-md ring-1',
                            'ring-gray-300' => !$errors->has('banner'),
                            'ring-red-500' => $errors->has('banner')
                        ])
                        :class="imagePreview ? 'hidden' : 'flex items-center justify-center'"
                    >
                        <div class="flex items-center gap-4">
                            <svg xmlns="http://www.w3.org/2000/svg" fill="none" viewBox="0 0 24 24" stroke-width="1.5" stroke="#030712" class="w-10 h-10">
                                <path stroke-linecap="round" stroke-linejoin="round" d="M2.25 15.75l5.159-5.159a2.25 2.25 0 013.182 0l5.159 5.159m-1.5-1.5l1.409-1.409a2.25 2.25 0 013.182 0l2.909 2.909m-18 3.75h16.5a1.5 1.5 0 001.5-1.5V6a1.5 1.5 0 00-1.5-1.5H3.75A1.5 1.5 0 002.25 6v12a1.5 1.5 0 001.5 1.5zm10.5-11.25h.008v.008h-.008V8.25zm.375 0a.375.375 0 11-.75 0 .375.375 0 01.75 0z" />
                            </svg>
                            <span class="text-gray-950 font-medium">Banner</span>
                        </div>
                    </div>
                            ...
                            <label class="cursor-pointer">
                                ...
                                >
                                    <div class="flex items-center gap-4">
                                        ...
                                        <span class="text-gray-950 font-medium">Icon</span>
                                    </div>
                                </div>
                        ...
                        <div class="mb-4 flex justify-between">
                            ...
                            <div class="flex items-center bg-bg-200 rounded-md shadow-md">
                                ...
                                <div class="px-2 flex flex-col">
                                    ...
                                    <span class="text-sm">Xh XXmin</span>
                                </div>
                            </div>
                        </div>
                        <div>
            ...
            >Add movie</button>
            <x-loading :x-show="'loading'">Adding the movie is in progress</x-loading>
        </form>
    </x-main-with-box>
</x-layout>
